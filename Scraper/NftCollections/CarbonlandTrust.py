...
def updateCarbonlandTrustPrices():
    ...
    # ----------------------------------- 7 day ----------------------------------- #
        ...
        db.child(f"{i+10}").update({"rank": carbonswapNftData["rank"]})
        db.child(f"{i+10}").update({"id": carbonswapNftData["id"]})
        db.child(f"{i+10}").update({"name": carbonswapNftData["name"]})
        db.child(f"{i+10}").update({"description": carbonswapNftData["description"]})
        db.child(f"{i+10}").update({"image": carbonswapNftData["image"]})
        db.child(f"{i+10}").update({"imageanimated": carbonswapNftData["imageanimated"]})
        db.child(f"{i+10}").update({"cheapestpriceoriginal": carbonswapNftData["cheapestpriceoriginal"]})
        db.child(f"{i+10}").update({"cheapestpricecurrency": carbonswapNftData["cheapestpricecurrency"]})
        db.child(f"{i+10}").update({"cheapestmarket": carbonswapNftData["cheapestpricemarket"]})
        db.child(f"{i+10}").update({"cheapestmarketlink": carbonswapNftData["cheapestpricemarketlink"]})
        db.child(f"{i+10}").update({"marketcap": carbonswapNftData["marketcap"]})
        db.child(f"{i+10}").update({"floorpricesevenday": carbonswapNftData["floorpricesevenday"]})
        db.child(f"{i+10}").update({"floorpricefourteenday": carbonswapNftData["floorpricefourteenday"]})
        db.child(f"{i+10}").update({"floorpricethirtyday": carbonswapNftData["floorpricethirtyday"]})
        db.child(f"{i+10}").update({"floorpricesixtyday": carbonswapNftData["floorpricesixtyday"]})
        db.child(f"{i+10}").update({"percentage7daycolor": carbonswapNftData["percentage7daycolor"]})
        db.child(f"{i+10}").update({"percentage14daycolor": carbonswapNftData["percentage14daycolor"]})
        db.child(f"{i+10}").update({"percentage30daycolor": carbonswapNftData["percentage30daycolor"]})
        db.child(f"{i+10}").update({"percentage60daycolor": carbonswapNftData["percentage60daycolor"]})
        db.child(f"{i+10}").update({"circulating": carbonswapNftData["circulating"]})
        db.child(f"{i+10}").update({"floorprice": carbonswapNftData["floorprice"]})
        db.child(f"{i+10}").update({"owners": carbonswapNftData["owners"]})
        db.child(f"{i+10}").update({"assettype": carbonswapNftData["assettype"]})
