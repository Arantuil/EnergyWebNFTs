...
def updateEnergymonPrices():
    ...
    db.child(f"{21}").update({"rank": carbonswapNftData["rank"]})
    db.child(f"{21}").update({"id": carbonswapNftData["id"]})
    db.child(f"{21}").update({"name": carbonswapNftData["name"]})
    db.child(f"{21}").update({"description": carbonswapNftData["description"]})
    db.child(f"{21}").update({"image": carbonswapNftData["image"]})
    db.child(f"{21}").update({"imageanimated": carbonswapNftData["imageanimated"]})
    db.child(f"{21}").update({"cheapestpriceoriginal": carbonswapNftData["cheapestpriceoriginal"]})
    db.child(f"{21}").update({"cheapestpricecurrency": carbonswapNftData["cheapestpricecurrency"]})
    db.child(f"{21}").update({"cheapestmarket": carbonswapNftData["cheapestpricemarket"]})
    db.child(f"{21}").update({"cheapestmarketlink": carbonswapNftData["cheapestpricemarketlink"]})
    db.child(f"{21}").update({"marketcap": carbonswapNftData["marketcap"]})
    db.child(f"{21}").update({"floorpricesevenday": carbonswapNftData["floorpricesevenday"]})
    db.child(f"{21}").update({"floorpricefourteenday": carbonswapNftData["floorpricefourteenday"]})
    db.child(f"{21}").update({"floorpricethirtyday": carbonswapNftData["floorpricethirtyday"]})
    db.child(f"{21}").update({"floorpricesixtyday": carbonswapNftData["floorpricesixtyday"]})
    db.child(f"{21}").update({"percentage7daycolor": carbonswapNftData["percentage7daycolor"]})
    db.child(f"{21}").update({"percentage14daycolor": carbonswapNftData["percentage14daycolor"]})
    db.child(f"{21}").update({"percentage30daycolor": carbonswapNftData["percentage30daycolor"]})
    db.child(f"{21}").update({"percentage60daycolor": carbonswapNftData["percentage60daycolor"]})
    db.child(f"{21}").update({"circulating": carbonswapNftData["circulating"]})
    db.child(f"{21}").update({"floorprice": carbonswapNftData["floorprice"]})
    db.child(f"{21}").update({"owners": carbonswapNftData["owners"]})
    db.child(f"{21}").update({"assettype": carbonswapNftData["assettype"]})
    print(f"Updated NFT with ID: {21}")