...
allNftList = [
"0xcaddd9a06044d566b880dc2ff6dce8558cc4903d"
] 
...
def updateBeatsBoyzPrices():
    ...
    url = "https://raregems.io/energyweb/beats-boyz"
...
#    percentage60day = (greenseapriceslistusd[0]/greenseapriceslistusd60day[0]*100)-100
    ...
    if combinedpriceslistoriginal[3] == 'Raregems':
        cheapestpricemarketlink = f"https://raregems.io/energyweb/beats-boyz/{combinedpriceslistoriginal[2]}"
    ...
    carbonswapNftData = {
        ...
        "id": 26,
        "name": "Beats Boyz",
        "projectlink": "https://beatsboyz.com/",
        "description": "Beats Boyz is landing on the EWC in form of ERC1155 collection!",
        "islistedongs": "false",
        "islistedonrg": "true",
        "islistedoncj": "false",
        "image": image,
    ...
    db.reference(f"{26}").update({"rank": carbonswapNftData["rank"]})
    db.reference(f"{26}").update({"id": carbonswapNftData["id"]})
    db.reference(f"{26}").update({"name": carbonswapNftData["name"]})
    db.reference(f"{26}").update({"projectlink": carbonswapNftData["projectlink"]})
    db.reference(f"{26}").update({"description": carbonswapNftData["description"]})
    db.reference(f"{26}").update({"islistedongs": carbonswapNftData["islistedongs"]})
    db.reference(f"{26}").update({"islistedonrg": carbonswapNftData["islistedonrg"]})
    db.reference(f"{26}").update({"islistedoncj": carbonswapNftData["islistedoncj"]})
    db.reference(f"{26}").update({"image": carbonswapNftData["image"]})
    db.reference(f"{26}").update({"imageanimated": carbonswapNftData["imageanimated"]})
    db.reference(f"{26}").update({"cheapestpriceoriginal": carbonswapNftData["cheapestpriceoriginal"]})
    db.reference(f"{26}").update({"cheapestpricecurrency": carbonswapNftData["cheapestpricecurrency"]})
    db.reference(f"{26}").update({"cheapestmarket": carbonswapNftData["cheapestpricemarket"]})
    db.reference(f"{26}").update({"cheapestmarketlink": carbonswapNftData["cheapestpricemarketlink"]})
    db.reference(f"{26}").update({"marketcap": carbonswapNftData["marketcap"]})
    db.reference(f"{26}").update({"floorpricesevenday": carbonswapNftData["floorpricesevenday"]})
    db.reference(f"{26}").update({"floorpricefourteenday": carbonswapNftData["floorpricefourteenday"]})
    db.reference(f"{26}").update({"floorpricethirtyday": carbonswapNftData["floorpricethirtyday"]})
    db.reference(f"{26}").update({"floorpricesixtyday": carbonswapNftData["floorpricesixtyday"]})
    db.reference(f"{26}").update({"percentage7daycolor": carbonswapNftData["percentage7daycolor"]})
    db.reference(f"{26}").update({"percentage14daycolor": carbonswapNftData["percentage14daycolor"]})
    db.reference(f"{26}").update({"percentage30daycolor": carbonswapNftData["percentage30daycolor"]})
    db.reference(f"{26}").update({"percentage60daycolor": carbonswapNftData["percentage60daycolor"]})
    db.reference(f"{26}").update({"circulating": carbonswapNftData["circulating"]})
