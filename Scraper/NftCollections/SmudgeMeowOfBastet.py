...
def updateSmudgeMeowOfBastetPrices():
    ...
    # ----------------------------------- 7 day ----------------------------------- #
        ...
        db.reference(f"{i+11}").update({"rank": carbonswapNftData["rank"]})
        db.reference(f"{i+11}").update({"id": carbonswapNftData["id"]})
        ...
        db.reference(f"{i+11}").update({"cheapestpricecurrency": carbonswapNftData["cheapestpricecurrency"]})
        db.reference(f"{i+11}").update({"cheapestmarket": carbonswapNftData["cheapestpricemarket"]})
        db.reference(f"{i+11}").update({"cheapestmarketlink": carbonswapNftData["cheapestpricemarketlink"]})
        db.reference(f"{i+11}").update({"marketcap": carbonswapNftData["marketcap"]})
        db.reference(f"{i+11}").update({"floorpricesevenday": carbonswapNftData["floorpricesevenday"]})
        db.reference(f"{i+11}").update({"floorpricefourteenday": carbonswapNftData["floorpricefourteenday"]})
        db.reference(f"{i+11}").update({"floorpricethirtyday": carbonswapNftData["floorpricethirtyday"]})
        db.reference(f"{i+11}").update({"floorpricesixtyday": carbonswapNftData["floorpricesixtyday"]})
        db.reference(f"{i+11}").update({"percentage7daycolor": carbonswapNftData["percentage7daycolor"]})
        db.reference(f"{i+11}").update({"percentage14daycolor": carbonswapNftData["percentage14daycolor"]})
        db.reference(f"{i+11}").update({"percentage30daycolor": carbonswapNftData["percentage30daycolor"]})
        db.reference(f"{i+11}").update({"percentage60daycolor": carbonswapNftData["percentage60daycolor"]})
        db.reference(f"{i+11}").update({"circulating": carbonswapNftData["circulating"]})
