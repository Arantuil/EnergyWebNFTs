...
def updateSmudgeCatworldPrices():
    ...
    try:
        ...
        select.select_by_value('0x7facb4502da6e0021fad92f34b7e75fb695a63cf')
...
#    percentage60day = (greenseapriceslistusd[0]/greenseapriceslistusd60day[0]*100)-100
    ...
    db.reference(f"{25}").update({"cheapestpricecurrency": carbonswapNftData["cheapestpricecurrency"]})
    db.reference(f"{25}").update({"cheapestmarket": carbonswapNftData["cheapestpricemarket"]})
    db.reference(f"{25}").update({"cheapestmarketlink": carbonswapNftData["cheapestpricemarketlink"]})
    db.reference(f"{25}").update({"marketcap": carbonswapNftData["marketcap"]})
    db.reference(f"{25}").update({"floorpricesevenday": carbonswapNftData["floorpricesevenday"]})
    db.reference(f"{25}").update({"floorpricefourteenday": carbonswapNftData["floorpricefourteenday"]})
    db.reference(f"{25}").update({"floorpricethirtyday": carbonswapNftData["floorpricethirtyday"]})
    db.reference(f"{25}").update({"floorpricesixtyday": carbonswapNftData["floorpricesixtyday"]})
    db.reference(f"{25}").update({"percentage7daycolor": carbonswapNftData["percentage7daycolor"]})
    db.reference(f"{25}").update({"percentage14daycolor": carbonswapNftData["percentage14daycolor"]})
    db.reference(f"{25}").update({"percentage30daycolor": carbonswapNftData["percentage30daycolor"]})
    db.reference(f"{25}").update({"percentage60daycolor": carbonswapNftData["percentage60daycolor"]})
    db.reference(f"{25}").update({"circulating": carbonswapNftData["circulating"]})
    db.reference(f"{25}").update({"floorprice": carbonswapNftData["floorprice"]})
    db.reference(f"{25}").update({"owners": carbonswapNftData["owners"]})
    db.reference(f"{25}").update({"assettype": carbonswapNftData["assettype"]})
