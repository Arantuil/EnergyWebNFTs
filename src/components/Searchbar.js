...
function Searchbar({ placeholder, data }) {
    ...
    return (
        <div className='w-full'>
            <div className='w-full'>
                <input id='searchinput' onChange={handleFilter} placeholder={placeholder} className='mb-1 p-[2px]
            ...
            rounded-md w-[88vw] sm:w-[70vw] md:w-[40vw] lg:w-[20vw] bg-bgsecondary dark:bg-darkbgsecondary z-[49] absolute flex flex-col overflow-hidden'>
                {filtereddata.map((value,key) => {
                    return ( 
                        <div className='p-[2px] z-50 w-full h-[38px]
                            bg-gradient-to-r from-[rgba(90,229,103,0.8)] via-[rgba(68,190,212,0.8)] to-[rgba(166,101,250,0.8)]
                            '>
